...
| `Multinomial_logistic_regression` | Prediction, probabilities, class metadata | Multiclass label and log-loss scorers and grid search | Coefficients, intercepts, scores, probabilities, predictions | Matrix decision scores are available directly from the estimator |
