...
- Feature unions and nestable preprocessing chains compose reusable transformations with shared inputs, deterministic feature names, and fold-local fitting.
